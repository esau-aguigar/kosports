        ...
        <div class="w3-main" >
          <div class="w3-row w3-padding-64">
            <div class="row">
              ...
              <div class="col-sm-3"></div>
              <div class="col-sm-3">
                <button class="btn btn-outline-primary" onclick="window.history.go(-1)">Regresar</button>
              </div>
            </div>
            <div class="row">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-sm">
                      ...
                      <tbody>
                        <?php
                          $queryDetalle="
                          SELECT * FROM detalleCompra DV
                          JOIN facturacompra FV ON DV.factura = FV.folio
                          ...
                          if(mysqli_num_rows($queryDetalle)){
                            while ($rowDetalles=mysqli_fetch_array($queryDetalle)) {
                              ?>
                              <tr>
                                <td><?php echo $rowDetalles['1']; ?></td>
                                <td><?php echo $rowDetalles[12]; ?></td>
                                <td><?php echo $rowDetalles['cantidad']; ?></td>
                                <td><?php echo $rowDetalles['precioVenta']; ?></td>
