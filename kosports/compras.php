...
<div class="w3-main" >
  <div class="w3-row w3-padding-64">
    <div class="row">
      ...
      <button type="button" class="btn btn-outline-info btn-lg" data-toggle="modal" data-target="#myModal">+ Recepcion</button>
                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                      ...
                      if ($sessionCode==1) {
                          ...
                          ORDER BY F.ID DESC";
                          $queryProductos2=mysqli_query($con,$queryProductos);
                      }else{
                        $queryProductos="
                        SELECT * FROM facturacompra F
                        JOIN usuario U on F.Usuario = U.codigo
                      ...
                      if(mysqli_num_rows($queryProductos2)){
                        while($row=mysqli_fetch_array($queryProductos2)){
                        ?>
                          <tr>
                            ...
                            <td>
                                <form method="post" action="recepcionInfo.php">
                                    <input type="hidden" name="facturainfo" value="<?php echo $row['folio']; ?>">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-success btn-lg" data-toggle="modal" data-target="#ModalReceipt" onclick="nvaFactura();">Aceptar</button>
      </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-primary" data-dismiss="modal" onclick="window.location.replace('compras.php');">Finalizar Captura</button>
          <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Cancelar venta</button>
        </div>
...
<script>
  ...
  function addItem(){
    ...
    opc.innerHTML = '<button class="btn btn-outline-danger">Quitar</button>';
