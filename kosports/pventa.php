...
<div class="w3-main" >
  <div class="w3-row w3-padding-64">
    <div class="row">
      ...
      <button type="button" class="btn btn-outline-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="nvaFactura()">Nueva venta</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-primary" data-dismiss="modal" onclick="window.location.replace('pventa.php');">Finalizar venta</button>
